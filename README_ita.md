...
```text
HYDRA-UMC-SUITE/
├── main.py                        # Punto di ingresso - schermo intero 1920x1080 min, F11 alterna schermo intero/finestra
├── requirements.txt
...
│   │   └── viewport.py              # QOpenGLWidget - vera pipeline di shader GLSL, camera orbitale
│   └── ui/
