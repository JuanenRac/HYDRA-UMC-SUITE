...
- **🪟 Andockbarer Arbeitsbereich im Photoshop-Stil** - jedes Panel ist ein
  ...
  aufteilen, schließen und über das Ansicht-Menü wieder anzeigen.
...
- **[HYDRA-UMC-DSI](https://github.com/JuanenRac/HYDRA-UMC-DSI)** — geplant: eine native Touch-UI für den eigenen 5"/7"-DSI-Touchscreen (1280×720, gleiche Auflösung bei beiden Größen) von HYDRA-UMC auf dem Compute Module 5, die diesen selben Server direkt von der Platine aus steuert. Noch nicht begonnen.
...
**Diese Dokumentation** (dieses README und seine eigenen Übersetzungen - `README_spa.md`, `README_ita.md`, `README_fra.md`, `README_deu.md`) ist verfügbar unter **Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)**. Vollständiger Text unter https://creativecommons.org/licenses/by-sa/4.0/.
