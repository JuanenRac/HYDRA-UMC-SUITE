...
def main():
    ...
    async def run_scenario():
        ...
        for model_name in ("UR5e (6-DOF)", "AR3 (6-DOF)", "Generic (6-DOF)", "xArm6 (6-DOF)", "Lite 6 (6-DOF)", "e.DO (6-DOF)", "Gen3 Lite (6-DOF)", "M-710iC (6-DOF)", "SO-ARM100 (5-DOF)", "Gen2 (6-DOF)", "PiPER (6-DOF)", "Z1 (6-DOF)", "ViperX 300 (6-DOF)", "WidowX 250 (6-DOF)"):
