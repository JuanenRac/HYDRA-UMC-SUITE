...
```text
HYDRA-UMC-SUITE/
├── main.py                        # Point d'entrée - plein écran 1920x1080 min, F11 bascule plein écran/fenêtré
├── requirements.txt
...
│   │   └── viewport.py              # QOpenGLWidget - vrai pipeline de shaders GLSL, caméra orbitale
│   └── ui/
