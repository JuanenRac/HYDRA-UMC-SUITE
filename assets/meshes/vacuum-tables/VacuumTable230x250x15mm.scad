// =============================================================================
// HYDRA-UMC - VacuumTable230x250x15mm.scad
// Parametric single-piece vacuum table for LumenPnP / JuanenPNP.
// Copyright (C) 2026 JuanenRac (Electro Hobby 3D) <electrohobby3d@gmail.com>
// GPL-3.0 - see LICENSE
// =============================================================================
// DIMENSIONS: 230x250mm (P1S clearance adjustment)
...
union() {
    difference() {
        // 1. SOLID BODY 230x250
        union() {
            cube([length, width, base_height]);
            // X- and Y-axis alignment walls
            ...
            // Side reinforcements for M5 fittings
        ...
        // 7. LOGO ENGRAVING (Front, below the grid)
        translate([length/2, 2.5, base_height/2])
            rotate([90,0,0])
                linear_extrude(height = 3)
                    text("JuanenPNP", size = 9, font = "sans:style=Bold", halign = "center", valign = "center");
    }

    // 8. INTERNAL PILLARS (Structural support for printing)
    intersection() {
        translate([15, 15, 4]) cube([length-30, width-30, base_height-8]);
        union() {
