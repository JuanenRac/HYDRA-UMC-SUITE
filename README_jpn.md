...
- **🛠️ CNC / レーザー ツールアタッチメント設定** —— 有効/無効の切り替え、幅/奥行き（mm）サイズ、リセットを、HYDRA-UMC STUDIO 自身の `CNC.tsx`/`Laser.tsx`（モジュールキー以外は同一のコンポーネント）から移植した1つの共有パネル実装で提供します。STUDIO がすでに持つ11個のツール別設定パネルのうち最初の2つで、残りは依然として現実の未解決のギャップです。
...
- 🐝 **オーケストレーションと群制御：** [HYDRA-UMC-SWARM-SYNC](https://github.com/JuanenRac/HYDRA-UMC-SWARM-SYNC) · [HYDRA-UMC-PATH-PLANNER-3D](https://github.com/JuanenRac/HYDRA-UMC-PATH-PLANNER-3D) · [HYDRA-UMC-JOB-DISPATCHER](https://github.com/JuanenRac/HYDRA-UMC-JOB-DISPATCHER) · [HYDRA-UMC-NODE-HEALING](https://github.com/JuanenRac/HYDRA-UMC-NODE-HEALING)
