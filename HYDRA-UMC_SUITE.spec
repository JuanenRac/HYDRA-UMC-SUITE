...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('assets', 'assets'), ('.venv/Lib/site-packages/PySide6/plugins/platforms', 'PySide6/plugins/platforms'), ('.venv/Lib/site-packages/PySide6/plugins/styles', 'PySide6/plugins/styles'), ('.venv/Lib/site-packages/PySide6/plugins/imageformats', 'PySide6/plugins/imageformats'), ('.venv/Lib/site-packages/PySide6/plugins/iconengines', 'PySide6/plugins/iconengines')],
