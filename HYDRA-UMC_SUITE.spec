...
a = Analysis(
    ...
    hiddenimports=['qasync', 'websockets', 'zeroconf', 'zeroconf.asyncio', 'zeroconf._utils.ipaddress', 'ifaddr', 'PySide6.QtOpenGL', 'PySide6.QtOpenGLWidgets', 'OpenGL.platform.win32'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
